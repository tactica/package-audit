  ...
  module Audit
    class TestErrors < Minitest::Test
      def test_that_it_prints_an_error_about_a_file_instead_of_a_directory
        output = `bundle exec package-audit report test/files/gemfile/report/Gemfile`
      ...
      def test_that_it_prints_an_error_about_a_non_existing_directory
        output = `bundle exec package-audit report test/files/gemfile/report/invalid`
      ...
      def test_that_it_prints_an_error_when_no_supported_technologies_are_found
        output = `bundle exec package-audit report test/files/`
