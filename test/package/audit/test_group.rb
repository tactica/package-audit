  ...
  module Audit
    class TestGroup < Minitest::Test
      def test_that_no_group_produces_expected_output
        output = `bundle exec package-audit report test/files/gemfile/groups`
      ...
      def test_that_default_group_produces_expected_output
        output = `bundle exec package-audit report test/files/gemfile/groups -g default`
      ...
      def test_that_development_group_produces_expected_output
        output = `bundle exec package-audit report test/files/gemfile/groups -g development`
      ...
      def test_that_test_group_produces_expected_output
        output = `bundle exec package-audit report test/files/gemfile/groups -g test`
      ...
      def test_that_production_group_produces_expected_output
        output = `bundle exec package-audit report test/files/gemfile/groups -g production`
      ...
      def test_that_multiple_groups_produces_expected_output
        output = `bundle exec package-audit report test/files/gemfile/groups -g test -g production`
